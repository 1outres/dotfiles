# Generated by Powerlevel10k configuration wizard on 2026-04-03 at 23:47 JST.
...
() {
  ...
  # Emit OSC 133 prompt markers from p10k itself. The terminal's own shell
  # integration must stay off: it rewrites PS1 by replacing every newline,
  # which corrupts p10k's parameter expansions that contain literal newlines.
